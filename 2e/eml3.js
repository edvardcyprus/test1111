...
function tmpeblankd1 () {
  ...
  // перем
  document.getElementById("modal_content_tmp1d1").innerHTML = helloen + greetingen[Math.floor(Math.random()*greetingen.length)] + tmpeblankd1text + contactusen[Math.floor(Math.random()*contactusen.length)] + byeen;  
...
function tmpeblankd2 () {
  ...
  // перем
  document.getElementById("modal_content_tmp1d2").innerHTML = hellogr + greetinggr[Math.floor(Math.random()*greetinggr.length)] + tmpeblankd2text + contactusgr[Math.floor(Math.random()*contactusgr.length)] + byegr;  
...
function tmpeblankd3 () {
  ...
  // перем
  document.getElementById("modal_content_tmp1d3").innerHTML = helloru + greetingru[Math.floor(Math.random()*greetingru.length)] + tmpeblankd3text + contactusru[Math.floor(Math.random()*contactusru.length)] + byeru;  
