...
document.getElementById("modal_button_screenshowd4").classList.add("displaynone"); // убр скр
document.getElementById("modal_button_screenshowd5").classList.add("displaynone"); // убр скр
document.getElementById("modal_button_screenshowd6").classList.add("displaynone"); // убр скр
document.getElementById("modal_button_screenshowd7").classList.add("displaynone"); // убр скр
document.getElementById("modal_button_screenshowd8").classList.add("displaynone"); // убр скр
document.getElementById("modal_button_screenshowd9").classList.add("displaynone"); // убр скр
document.getElementById("modal_button_screenshowd10").classList.add("displaynone"); // убр скр
document.getElementById("modal_button_screenshowd11").classList.add("displaynone"); // убр скр
document.getElementById("modal_button_screenshowd12").classList.add("displaynone"); // убр скр
...
function tmpcblankd1 () {
  ...
  document.getElementById("modal_nametmp1d1").innerHTML = tmpd1nameonly + ": " + namecblank;  
...
function tmpcblankd2 () {
  ...
  document.getElementById("tabname").innerHTML = tabnamedev;  
  document.getElementById("tabhome").innerHTML = tabhome; 
  document.getElementById("modal_nametmp1d2").innerHTML = tmpd2nameonly + ": " + namecblank;  
...
function tmpcblankd3 () {
  ...
  document.getElementById("tabname").innerHTML = tabnamedev;  
  document.getElementById("tabhome").innerHTML = tabhome; 
  document.getElementById("modal_nametmp1d3").innerHTML = tmpd3nameonly + ": " + namecblank;  
